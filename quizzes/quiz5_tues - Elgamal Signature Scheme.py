# Consider the following parameters for the elgamal signature scheme
...
# s1 = (x1 - d · r1)kE_inv (mod p − 1)
# s2 = (x2 - d · r2)kE_inv (mod p − 1)
# s1 - s2 = (x1 - d · r1)kE_inv - (x2 - d · r2)kE_inv (mod p − 1)
# s1 - s2 = (x1 - x2)kE_inv (mod p − 1)
# kE(s1 - s2) = (x1 - x2) (mod p − 1)
# kE = (x1 - x2) / (s1 - s2) (mod p − 1)
# kE = (s1 - s2)_inv (x1 - x2) (mod p − 1)
